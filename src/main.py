...
while cap.isOpened():
    ...
    if curr_food_rec_time > 0:
        ...
        # Output Results
        cv2.putText(frame, str(pan_label_name), (0, 200), cv2.FONT_HERSHEY_SIMPLEX, 3, (255, 100, 0), 5)
        cv2.putText(frame, str(food_label_name), (0, 400), cv2.FONT_HERSHEY_SIMPLEX, 3, (255, 100, 0), 5)
        cv2.putText(frame, str(gesture), (0, 600), cv2.FONT_HERSHEY_SIMPLEX, 3, (0, 100, 255), 5)
